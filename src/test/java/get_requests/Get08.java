...
//Do assertion
      ...
      //Assert that there are 10 ids greater than 190
        ...
        System.out.println("counter = " + idsGreaterThan190);
        assertEquals(10,idsGreaterThan190);

        //2nd way:recommended
        List<Object> intListGroovy = jsonPath.getList("findAll{it.id>190}.id");
        System.out.println("intListGroovy = " + intListGroovy);//Groovy:Java based programming language
        assertEquals(100,intListGroovy.size());
